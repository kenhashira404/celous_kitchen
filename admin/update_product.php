...
if (isset($_POST['update'])) {
   ...
   $description = $_POST['description']; // Added line
   $description = filter_var($description, FILTER_SANITIZE_STRING); // Added line
   ...
   <section class="update-product">
      ...
      ?>
            <form action="" method="POST" enctype="multipart/form-data">
               ...
               <textarea name="description" placeholder="Enter product description" class="box"><?= $fetch_products['description']; ?></textarea>
